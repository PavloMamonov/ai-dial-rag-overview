...
class MicrowaveRAG:
    ...
    def _setup_vectorstore(self) -> VectorStore:
        ...
        # Get the directory of the current file for proper path handling
    ...
    def _create_new_index(self) -> VectorStore:
        ...
        # Get the directory of the current file and construct the path to microwave_manual.txt
        current_dir = os.path.dirname(os.path.abspath(__file__))
        loader = TextLoader(
    ...
    def retrieve_context(self, query: str, k: int = 4, score=0.3) -> str:
        ...
        for i, (doc, result_score) in enumerate(results, 1):
            ...
            # Print result score and page content
